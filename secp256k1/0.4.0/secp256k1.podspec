Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
This pod binds the bitcoin-core library, the ECDSA curve, secp256k1. This curve is used for
Bitcoin, Ethereum and many other Cryptocurrency Signature generation and verification.
  ...
  s.author           = { 'Jonathan Serra' => 'jonathan@blocs.fr' }
  s.source           = { :git => 'https://github.com/bitcoin-core/secp256k1.git' }
  ...
  s.compiler_flags = 
    '-Wno-shorten-64-to-32', '-Wno-conditional-uninitialized',
  ...
  s.source_files = '{src,include,contrib}/*.{h,c}', 'src/modules/{recovery,ecdh}/*.{h,c}'
  s.exclude_files =
    'src/*bench*.{c,h}',
    'src/*test*.{c,h}',
    'src/gen_context.c'

  s.xcconfig = { "HEADER_SEARCH_PATHS" => "${PODS_ROOT}/secp256k1" }
end
